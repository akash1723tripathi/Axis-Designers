...
/* ─── Team culture photos ─── */
const culturePhotos = [
      { src: "/team_photos/alok_singh_image.png", alt: "Team at work" },
      { src: "/team_photos/amit_jain_image.png", alt: "Design review session" },
      { src: "/team_photos/Pancham_singh_image.png", alt: "On-site coordination" },
      { src: "/team_photos/alok_singh_image.png", alt: "Creative brainstorm" },
      { src: "/team_photos/amit_jain_image.png", alt: "Team celebration" },
      { src: "/team_photos/Pancham_singh_image.png", alt: "Workshop session" },
];
